...
(function () {
  var Star = function () {
    ...
    this.customUniforms = {
      ...
      scalesize: {type: 'f', value: 1.0},
      starcolor: {type: 'c', value: new THREE.Color(0xffffff)},
    ...
    this.nebulaParticles = 155;
    this.glowParticles = 85;
    ...
    function makeParticleGeometry(count, cAttrs) {
      ...
      for(var i = 0 ; i < count; i++){
        ...
        // cAttrs.customColor.value[i] = new THREE.Color(0x00ff00);
    ...
    window.glowParticleSphere = this.glowParticleSphere;
  ...
  Star.prototype.scale = function(n) {
    ...
    this.customUniforms.scalesize.value = n;
    this.customUniforms2.scalesize.value = n;
  };
  ...
  Star.prototype.determineColor = function(temperature) {
    ...
    return this._averages[this._averages.length - 1][1];
  };
